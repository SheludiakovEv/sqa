...
public class CreateGroupTests {
    ...
    public void createGroup() {
        ...
        driver.findElement(By.name("group_name")).sendKeys("gg");
        driver.findElement(By.name("group_header")).click();
        driver.findElement(By.name("group_header")).sendKeys("gg");
        driver.findElement(By.name("group_footer")).click();
        driver.findElement(By.name("group_footer")).sendKeys("gg");
